...
import 'aicon_profile_model.dart';
export 'aicon_profile_model.dart';

class AiconProfileWidget extends StatefulWidget {
  const AiconProfileWidget({super.key});

  @override
  State<AiconProfileWidget> createState() => _AiconProfileWidgetState();
}

class _AiconProfileWidgetState extends State<AiconProfileWidget> {
  late AiconProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AiconProfileModel());
  }
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: RatingBar.builder(
                                ...
                                itemCount: 5,
                                itemSize: 24.0,
                                glowColor: const Color(0xFFEEA035),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
